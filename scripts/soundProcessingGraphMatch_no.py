...
for i in range(4096):
    ...
    ch1_mas.append(ch1 - 80); ch2_mas.append(ch2 - 135); n_mas.append(n * ((0.2 * 10 ** (-3)) / 160))
...
plt.ylabel("A")
plt.grid()
plt.savefig('graph_without_shift_no.svg')
plt.show()
...
plt.ylabel("A")
plt.grid()
plt.savefig('graph_with_shift_no.svg')
plt.show()
