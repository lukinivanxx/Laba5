...
fig, ax = plt.subplots()
ax.scatter(c_clear_air, a_clear_air, marker='D', edgecolors='black', s=30, label='Значения в воздухе: 346.577 м/с, 0.542 %', color='yellow', zorder=4)
ax.scatter(c_no, a_no, marker='D', edgecolors='black', s=30, label='Значения в выдохе: 344.515 м/с, 2.437 %', color='red', zorder=4)
